...
public class OnlineFriendItemController implements Initializable {

    private OnlineFriendsController ofc;
    ...
    public void setData(GraphicalInterface graphicalInterface, User friend, int index,OnlineFriendsController ofc) {
